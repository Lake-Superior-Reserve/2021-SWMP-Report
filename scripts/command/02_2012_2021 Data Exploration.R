#Run 01 Command Data Prep.R script first to get fully qaqc data
#That script creates 4 dataframes, one for each site, that will be that starting point here

#load workspace from previous script if needed 
load(file = "011323_1335.RData")
...
#source("scripts/companion/03SWMPtrendprep.R")

#delving into some data exploration using SWMPr and SWMPrExtension functions
